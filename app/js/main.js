...
(() => {
  var e = {
      ...
      319: () => {
        ...
        const t = document.querySelectorAll(".js-link");
        t.forEach((t) => {
        ...
        const n = document.querySelectorAll(".section-js");
        window.addEventListener("scroll", () => {
          ...
          n.forEach((t) => {
            ...
            n < r && n >= 0 && ((e = t.getAttribute("id")), (r = n));
          }),
            (i = e),
            t.forEach((e) => {
          ...
          document.querySelectorAll(".accordion__item").forEach((t) => {
        ...
        !(function (e) {
          ...
          function v(e) {
            ...
            p.addEventListener("refresh", w),
              ...
              p.defaults({ scroller: M });
            var U = p.getAll().filter(function (e) {
              return e.scroller === o || e.scroller === M;
            });
            U.forEach(function (e) {
              ...
              (this.kill = function () {
                ...
                p.scrollerProxy(M),
                  ...
                  (k.style.cssText = D);
                var n = p.defaults({});
                n && n.scroller === M && p.defaults({ scroller: o }),
      ...
      576: function (e, t) {
        !(function (e) {
          ...
          function l(e, t) {
            function n(r) {
              if (r || 0 === r) {
                ...
                var i = E && E.isPressed;
                (r = n.v = Math.round(r) || (E && E.iOS ? 1 : 0)),
                  e(r),
                  (n.cacheID = P.cache),
                  i && z("ss", r);
              } else
            ...
            ((N.prototype.init = function (e) {
              ...
              function ye(e, t, n) {
                (Ge[n] += e),
                  ...
                  Fe._vx.update(e),
                  Fe._vy.update(t),
                  M ? (Pe = Pe || requestAnimationFrame(ve)) : ve();
              }
              function be(e, t) {
                fe &&
                  !$e &&
              ...
              (this.target = l = c(l) || x),
                ...
                (M = !1 !== M),
                (C = C || parseFloat(y.getComputedStyle(_).lineHeight) || 22);
              var Pe,
                Ae,
                Oe,
                ze,
                ...
                (Fe.enable = function (e) {
                  return (
                    Fe.isEnabled ||
                      ...
                      0 <= r.indexOf("wheel") && s(l, "wheel", Ce, P, de),
                      ((0 <= r.indexOf("touch") && w) ||
                        0 <= r.indexOf("pointer")) &&
                        (s(l, k[0], Ke, P, de),
                        s(je, k[2], _e),
          ...
          function Y() {
            return Ee || (X() && (Ee = window.gsap) && Ee.registerPlugin && Ee);
          }
          function j(e) {
            return !!~Oe.indexOf(e);
          }
          function G(e) {
            return (
              ...
              (j(e)
                ? function () {
                    return (
                      (Wt.width = Me.innerWidth),
                      (Wt.height = Me.innerHeight),
                      Wt
                    );
                  }
                : function () {
          ...
          function V(e, t) {
            ...
            return (n = "scroll" + i) && (o = r(e, n))
              ...
              : j(e)
              ? (Pe[n] || Ae[n]) -
                (Me["inner" + i] || Pe["client" + i] || Ae["client" + i])
              : e[n] - e["offset" + i];
          }
          function U(e, t) {
          ...
          function me() {
            (Qe = Me.innerWidth), (Ke = Me.innerHeight);
          }
          function ge() {
            P.cache++,
              Re ||
                ...
                (Ue &&
                  Qe === Me.innerWidth &&
                  !(Math.abs(Me.innerHeight - Ke) > 0.25 * Me.innerHeight)) ||
                ze.restart(!0);
          }
          function ve() {
          ...
          function Te(e, t, n, r, i, s, o, a, l, u, d, p, f) {
            ...
            var h,
              ...
              g,
              v = f ? f.time() : 0;
            if ((f && f.seek(0), Z(e))) o && Et(o, n, r, !0);
            else {
              Q(t) && (t = t(a));
              var y,
                b,
              ...
              (g = c(t) || Ae),
                ...
                o && Et(o, x, r, n - x < 20 || (o._isStart && 20 < x)),
                (n -= n - x);
            }
            if (s) {
              var T = e + n,
            ...
            Ht = function (e) {
              if (e) {
                var t,
                  ...
                  s = 0;
                for (
                  (e.t._gsap || Ee.core.getCache(e.t)).uncache = 1;
                  s < i;
                  s += 2
                )
                  (n = e[s + 1]),
            ...
            Xt =
              ((Yt.prototype.init = function (e, t) {
                if (
                  ...
                  var n,
                    ...
                    ot = !xe && 0 !== xe,
                    ut = c(e.scroller || Me),
                    dt = Ee.core.getCache(ut),
                    Ct = j(ut),
                    Et =
                      "fixed" ===
                      ("pinType" in e
                        ? e.pinType
                        : r(ut, "pinType") || (Ct && "fixed")),
                    ...
                    It = (function (e, t, n) {
                      ...
                      return (o = r(e, "getBoundingClientRect"))
                        ...
                        : function () {
                            return (t ? Me["inner" + s] : e["client" + s]) || 0;
                          };
                    })(ut, Ct, tt),
                    Ft = (function (e, t) {
                  ...
                  if (
                    ...
                    Ge &&
                      ...
                      "scrollBehavior" in Ae.style &&
                        Ee.set(Ct ? [Ae, Pe] : ut, { scrollBehavior: "auto" }),
                      (s = Q(Ge.snapTo)
                        ? Ge.snapTo
                        : "labels" === Ge.snapTo
                        ? (function (e) {
                    ...
                    Oe &&
                      ...
                      (zt.pin = Oe),
                      !1 !== e.force3D && Ee.set(Oe, { force3D: !0 }),
                      (i = Ee.core.getCache(Oe)).spacer
                        ? (y = i.pinState)
                        : (Ue &&
                            ((Ue = c(Ue)) &&
                              !Ue.nodeType &&
                          ...
                          (i.spacer = _ = Ue || Le.createElement("div")),
                    ...
                    (p = this.markerStart =
                      ...
                      Ke && (U = Ee.quickSetter([p, f], tt.a, _t)),
                      Et ||
                        ...
                        Ee.set([h, m], { force3D: !0 }),
                        (L = Ee.quickSetter(h, tt.a, _t)),
                        (P = Ee.quickSetter(m, tt.a, _t)));
                  }
                  if (Ke) {
                      ...
                      r !== zt.isReverted &&
                        ...
                        Oe &&
                          (r
                            ...
                            : (Ve && zt.isActive) || _e(Oe, _, ne(Oe), M)),
                        (zt.isReverted = r));
                    }),
                      ...
                      if ((!Re && zt.enabled) || i)
                        if (Oe && r && at) le(Yt, "scrollEnd", ve);
                          ...
                          for (
                            ...
                            (L = kt[te]).end || L.refresh(0, 1) || (Re = 1),
                              !(P = L.pin) ||
                                (P !== ke && P !== Oe) ||
                                L.isReverted ||
                                ((z = z || []).unshift(L), L.revert(!0, !0)),
                              L !== kt[te] && (ee--, te--);
                          for (
                            Q(U) && (U = U(zt)),
                              l =
                          ...
                          if (
                            ...
                            (s = ne(Oe)),
                              (S = tt === F),
                              (w = Bt()),
                              (C = parseFloat(T(tt.a)) + q),
                              !N &&
                                1 < d &&
                                ((Ct ? Ae : ut).style["overflow-" + tt.a] =
                                  "scroll"),
                              _e(Oe, _, s),
                              (x = we(Oe)),
                              (g = wt(Oe, !0)),
                          ...
                          z &&
                            ...
                            Oe &&
                              ze &&
                              (_._pinOffset = Math.round(zt.progress * E)),
                            be && be(zt);
                        }
                    }),
                      ...
                      if (!Ke || i || e) {
                        ...
                        if (
                          ...
                          if (
                            ...
                            if ((e && ze && (_.style[ze + tt.os2] = k), Et)) {
                              if (p) {
                                if (
                                  ((m =
                                    !e &&
              ...
              (Yt.disable = function (e, t) {
                (lt = 0),
                  ...
                  ce(Le, "touchcancel", W),
                  ce(Ae, "touchstart", W),
                  ae(ce, Le, "pointerdown,touchstart,mousedown", B),
                  ae(ce, Le, "pointerup,touchend,mouseup", H),
                  ze.kill(),
                  U(ce);
              ...
              (Yt.enable = function () {
                if (
                  ...
                  Ee &&
                    ((De = Ee.utils.toArray),
                    (Ie = Ee.utils.clamp),
                    (Je = Ee.core.context || W),
                    (je = Ee.core.suppressOverwrites || W),
                    Ee.core.globals("ScrollTrigger", Yt),
                    Ae))
                ) {
                  (lt = 1),
                    R.register(Ee),
                  ...
                  for (
                    i.revert ||
                      ...
                      le(Le, "touchcancel", W),
                      le(Ae, "touchstart", W),
                      ae(le, Le, "pointerdown,touchstart,mousedown", B),
                      ae(le, Le, "pointerup,touchend,mouseup", H),
                      Be = Ee.utils.checkPrefix("transform"),
                      Nt.push(Be),
                      ke = st(),
                      ze = Ee.delayedCall(0.2, Dt).pause(),
                      Xe = [
                        Le,
                        "visibilitychange",
                        function () {
              ...
              (Yt.scrollerProxy = function (e, t) {
                var n = c(e),
                  ...
                  i = j(n);
                ~r && P.splice(r, i ? 6 : 2),
                  t && (i ? A.unshift(Me, t, Ae, t, Pe, t) : A.unshift(n, t));
              }),
              ...
              (Yt.isInViewport = function (e, t, n) {
                var r = (K(e) ? c(e) : e).getBoundingClientRect(),
                  i = r[n ? pt : ft] * t || 0;
                return n
                  ? 0 < r.right - i && r.left + i < Me.innerWidth
                  : 0 < r.bottom - i && r.top + i < Me.innerHeight;
              }),
                ...
                var r = e.getBoundingClientRect(),
                  ...
                  s =
                    null == t
                      ...
                      : parseFloat(t) || 0;
                return n
                  ? (r.left + s) / Me.innerWidth
                  : (r.top + s) / Me.innerHeight;
              }),
          ...
          function Ut(e, t, n, r) {
            return R.create({
              ...
              onScroll: r,
              onEnable: function () {
                return n && le(Le, R.eventTypes[0], Jt, !1, !0);
              },
              onDisable: function () {
                return ce(Le, R.eventTypes[0], Jt, !0);
              },
            });
          }
          (Xt.version = "3.11.2"),
                  ...
                  : (function (e) {
                      ...
                      return (
                        ...
                        (e.onPress = function () {
                          var e = S;
                          (S = q(
                            ((Me.visualViewport && Me.visualViewport.scale) ||
                              1) / C
                          )),
                            d.pause(),
                            e !== S && Gt(y, 1.01 < S || (!m && "x")),
                        ...
                        (e.onEnable = function () {
                          Gt(y, !m && "x"), le(Me, "resize", i), M.enable();
                        }),
                        (e.onDisable = function () {
                          Gt(y, !0), ce(Me, "resize", i), M.kill();
                        }),
            ...
            function (e, t, n) {
              ...
              function P(e, t) {
                ...
                (s[t] = document.createElement("iframe")),
                  E(e, t, "".concat(x, " ").concat(i, "youtube-iframe")),
              ...
              function A(e, t) {
                var n = e.collections.sourceLoadHandlers,
                  ...
                  o = e.props.sources;
                (i[t] = o[t]),
                  E(e, t, "".concat(i[t].className, " ").concat(x)),
                  s[t].appendChild(i[t]),
        ...
        !(function (e) {
          ...
          function H(e, t) {
            ...
            if (
              ((t._time || (t._initted && !t._dur)) &&
                ((n = R(e.rawTime(), t)),
                (!t._dur || Et(0, t.totalDuration(), n) - t._tTime > Ve) &&
                  t.render(n, !0)),
          ...
          function W(e, t, n, r) {
            return (
              t.parent && D(t),
              (t._start = _(
                (s(n) ? n : n || e !== xe ? Ct(e, n, t) : e._time) + t._delay
              )),
              (t._end = _(
          ...
          var ve,
            ...
            It =
              ...
              (Oe = {
                ...
                sleep: function () {
                  (Ae ? _e.cancelAnimationFrame : clearTimeout)(Le),
                    (Me = 0),
                    (Pe = m);
                },
              ...
              ut.SteppedEase =
                {
                  config: function (e, t) {
                    ...
                    var n = 1 / e,
                      ...
                      i = t ? 1 : 0;
                    return function (e) {
                      return (((r * Et(0, 0.99999999, e)) | 0) + i) * n;
                    };
                  },
                }),
            (je.ease = Ft["quad.out"]),
              ...
              (Xt.totalTime = function (e, t) {
                ...
                return (
                  (this._tTime !== e ||
                    ...
                    (this._ts || (this._pTime = e), C(this, e, t)),
                  this
                );
              }),
          ...
          var Vt = (function (e) {
            ...
            return (
              ...
              (a.add = function (e, t) {
                var n = this;
                if ((s(t) || (t = Ct(this, t, e)), !(e instanceof jt))) {
                  if (nt(e))
                    return (
                      e.forEach(function (e) {
                        return n.add(e, t);
              ...
              (a.getTweensOf = function (e, t) {
                for (var n, r = [], i = Mt(e), o = this._first, a = s(t); o; )
                  o instanceof sn
                    ? T(o._targets, i) &&
                      (a
                        ? (!Qt || (o._initted && o._ts)) &&
              ...
              (a.previousLabel = function (e) {
                return (
                  void 0 === e && (e = this._time), se(this, Ct(this, e), 1)
                );
              }),
              ...
              (o.updateRoot = function (e) {
                if (
                  (xe._ts && (C(xe, R(e, xe)), (Ee = It.frame)), It.frame >= yt)
                ) {
                  yt += Ye.autoSleep || 120;
                  var t = xe._first;
                  if (
          ...
          M(Vt.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
          var Qt,
            Zt,
          ...
          var sn = (function (e) {
            function i(t, r, i, o) {
              ...
              var d,
                ...
                D = w.yoyoEase,
                I = r.parent || xe,
                $ = (nt(t) || tt(t) ? s(t[0]) : "length" in r) ? [t] : Mt(t);
              if (
                ((c._targets = $.length
                  ? g($)
                  : f(
                ...
                if (
                  ...
                  if (((m = $.length), (b = E && J(E)), a(E)))
                    for (v in E) ~nn.indexOf(v) && ((x = x || {})[v] = E[v]);
                  for (p = 0; p < m; p++)
                    ((h = P(r, rn)).stagger = 0),
                      D && (h.yoyoEase = D),
                      x && _t(h, x),
                  ...
                  A(M(d.vars.defaults, { ease: "none" })),
                    (d._ease = Ht(L.ease || r.ease || "none"));
                  var F,
                    R,
                    N,
                    B = 0;
          ...
          var Tn,
            ...
            kn = 0,
            Mn =
              (((Tn = Ln.prototype).add = function (e, t, n) {
                function r() {
                  var e,
                    r = be,
                    o = s.selector;
          ...
          var zn = {
            ...
            defaults: function (e) {
              return (
                e && e.ease && (e.ease = Ht(e.ease, je.ease)), L(je, e || {})
              );
            },
            config: function (e) {
              return L(Ye, e || {});
          ...
          function Qn() {
            ...
            if (this.tfm) {
              ...
              s.svg &&
                ...
                !(e = Er()) || e.isStart || i[ei] || (Kn(i), (s.uncache = 1));
            }
          }
          function Zn(e, t) {
          ...
          var xr,
            ...
            di = function (e, t) {
              ...
              return (
                ...
                n.svg &&
                  ((k = n.uncache
                    ? ((M = e.getBBox()),
                      (B = n.xOrigin - M.x + "px " + (n.yOrigin - M.y) + "px"),
                      "")
                ...
                g !== ci &&
                  ...
                  6 === g.length
                    ...
                    : ((I = g[6]),
                      ...
                      (c = (v = Ur(I, O)) * Gr),
                      v &&
                        ((k = C * (y = Math.cos(-v)) + P * (b = Math.sin(-v))),
                        (M = E * y + A * b),
                        (L = I * y + O * b),
                        (P = C * -b + P * y),
                        (A = E * -b + A * y),
            ...
            yi = function (e, t) {
              ...
              (p = parseFloat(p)),
                ...
                ((S && !~(u + "").indexOf("px")) ||
                  (C && !~(d + "").indexOf("px"))) &&
                  ((S = lr(v, "x", u, "px")), (C = lr(v, "y", d, "px"))),
                (y || b || _ || w) &&
                  ((S = x(S + y - (y * n + b * i) + _)),
                  (C = x(C + b - (y * r + b * s) + w))),
                (l || c) &&
                  ((S = x(S + (l / 100) * (o = v.getBBox()).width)),
                  (C = x(C + (c / 100) * o.height))),
                (o =
                  "matrix(" +
                  n +
                  "," +
                  ...
                  if (
                    ...
                    if (
                      ...
                      (o = (
                        ...
                        this.add(C, "setProperty", o, a, i, s, 0, 0, f),
                        S.push(f),
                        T.push(f, C[f]);
                    else if ("undefined" !== u) {
                      if (
                        ...
                        f in Jr &&
                          ("autoAlpha" === f &&
                            (1 === c &&
                              ...
                              l &&
                              (c = 0),
                            T.push("visibility", C.visibility),
                            ar(
                              this,
                              C,
                              "visibility",
                      ...
                      else if (f in C) cr.call(this, e, f, o, g ? g + a : a);
                      else {
                        if (!(f in e)) {
                          p(f, a);
                          continue;
        ...
        transition: {
          ...
          transitionStart: function (e = !0, t) {
            ...
            r.cssMode ||
              ...
              M({ swiper: n, runCallbacks: e, direction: t, step: "Start" }));
          },
          transitionEnd: function (e = !0, t) {
            ...
            (n.animating = !1),
              r.cssMode ||
                (n.setTransition(0),
                M({ swiper: n, runCallbacks: e, direction: t, step: "End" }));
          },
        },
        slide: L,
        loop: P,
