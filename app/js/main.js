          ...
          if (e.length > 0)
            for (let t = 0; t < e.length; t++) {
              ...
              n.addEventListener("click", function (e) {
                ...
                o(document.querySelector(`[data-popup="${t}"]`));
              });
            }
          const s = document.querySelectorAll(".popup__close");
          if (s.length > 0)
        ...
        !(function (e) {
          ...
          var R =
            ((N.prototype.init = function (e) {
              ...
              function ge(e, t) {
                return (
                  (($e.event = e) && D && ~D.indexOf(e.target)) ||
              ...
              function ve() {
                ...
                K && (r || i) && K($e, e, n, Ge, Ve),
                  ...
                  i &&
                    ...
                    j && $e.deltaY < 0 && j($e),
                    U && U($e),
                    Z && $e.deltaY < 0 != Ne < 0 && Z($e),
                    (Ne = $e.deltaY),
                    (Ve[0] = Ve[1] = Ve[2] = 0)),
                  (ze || Oe) &&
                    (te && te($e), Oe && (H($e), (Oe = !1)), (ze = !1)),
                  Ie && !(Ie = !1) && he && he($e),
                  De && (oe($e), (De = !1)),
                  (Pe = 0);
              }
              ...
              function be(e, t) {
                fe &&
                  !Fe &&
                  (($e.axis = Fe = Math.abs(e) > Math.abs(t) ? "x" : "y"),
                  (Ie = !0)),
                  "y" !== Fe && ((Ge[2] += e), $e._vx.update(e, !0)),
                  "x" !== Fe && ((Ve[2] += t), $e._vy.update(t, !0)),
                  M ? (Pe = Pe || requestAnimationFrame(ve)) : ve();
              }
              function xe(e) {
                if (!ge(e, 1)) {
                  ...
                  ($e.x = t),
                    ($e.y = r),
                    (o ||
                      Math.abs($e.startX - t) >= n ||
                      Math.abs($e.startY - r) >= n) &&
                      (H && (Oe = !0),
                      o || ($e.isDragging = !0),
                      be(i, s),
                      o || (N && N($e)));
              ...
              function _e(e) {
                if (!ge(e, 1)) {
                  ...
                  var t =
                      $e.isDragging &&
                      (3 < Math.abs($e.x - $e.startX) ||
                        3 < Math.abs($e.y - $e.startY)),
                    n = p(e);
                  t ||
                    ($e._vx.reset(),
                    $e._vy.reset(),
              ...
              (Ae = $e._dc =
                g
                  .delayedCall(z || 0.25, function () {
                    $e._vx.reset(), $e._vy.reset(), Ae.pause(), A && A($e);
                  })
                  .pause()),
                ($e.deltaX = $e.deltaY = 0),
                ($e._vx = d(0, 50, !0)),
          ...
          var Ce,
            ...
            Xt =
                ...
                if (
                  ...
                  for (
                    i.revert ||
                      ...
                      e = wt(Ae),
                      $.m = Math.round(e.top + $.sc()) || 0,
                      F.m = Math.round(e.left + F.sc()) || 0,
                      r
                        ? (n.borderTopStyle = r)
                        : n.removeProperty("border-top-style"),
                      $e = setInterval(fe, 250),
              ...
              (Yt.config = function (e) {
                ...
                (t && clearInterval($e)) || (($e = t) && setInterval(fe, t)),
              ...
              function Z(e) {
                ...
                (n.isInitialized = !0),
                  ...
                  (function (e) {
                    ...
                    for (var s = 0; s < r.length; s++) F(e, s);
                  })(e),
                  s.length > 1 &&
                    (function (e) {
        ...
        !(function (e) {
              ...
              (Oe = {
                ...
                add: function (e, t, n) {
                  var r = t
                    ...
                    : e;
                  return Oe.remove(e), We[n ? "unshift" : "push"](r), Ft(), r;
                },
                remove: function (e, t) {
          ...
          var Xt,
            ...
            jt =
              ...
              (Xt.time = function (e, t) {
                return arguments.length
                  ? this.totalTime(
                      Math.min(this.totalDuration(), e + $(this)) %
          ...
          var Qt,
            ...
            en = function e(t, n) {
              var r,
                ...
                $ = t._targets,
                R = t.parent,
                N = R && "nested" === R.data ? R.vars.targets : $,
          ...
          var sn = (function (e) {
            function i(t, r, i, o) {
              ...
              var d,
                ...
                D = w.yoyoEase,
                I = r.parent || xe,
                F = (nt(t) || tt(t) ? s(t[0]) : "length" in r) ? [t] : Mt(t);
              if (
                ((c._targets = F.length
                  ? g(F)
                  : f(
                ...
                if (
                  ...
                  (d = c.timeline =
                    new Vt({
                      data: "nested",
                      defaults: O || {},
                      targets: I && "nested" === I.data ? I.vars.targets : F,
                    })).kill(),
                  (d.parent = d._dp = n(c)),
                  (d._start = 0),
                  C || u(T) || u(S))
                ) {
                  if (((m = F.length), (b = C && J(C)), a(C)))
                  ...
                  for (p = 0; p < m; p++)
                    ((h = P(r, rn)).stagger = 0),
                      ...
                      x && _t(h, x),
                      (y = F[p]),
                      (h.duration = +tn(T, n(c), p, y, F)),
                      (h.delay = (+tn(S, n(c), p, y, F) || 0) - c._delay),
                      !C &&
                        1 === m &&
                        h.delay &&
                        ((c._delay = S = h.delay),
              ...
              return (
                !0 !== k || ve || ((Qt = n(c)), xe.killTweensOf(F), (Qt = 0)),
                W(I, n(c), i),
                ...
                if (h) {
                  if (
                    ...
                    (u &&
                      ...
                      this._onUpdate &&
                        !t &&
                        (m && F(this, e, 0, n), Pt(this, "onUpdate")),
                      this._repeat &&
                        s !== a &&
                        this.vars.onRepeat &&
                        !t &&
          ...
          var zn = {
            registerPlugin: function () {
              ...
              t.forEach(function (e) {
                return (function (e) {
                  ...
                  h(t, r), e.register && e.register(Fn, r, bn);
                })(e);
              });
            },
            timeline: function (e) {
            ...
            parseEase: function (e, t) {
              return arguments.length ? Ht(e, t) : $t;
            },
            getById: function (e) {
              return xe.getById(e);
            },
          ...
          function br(e, t, n) {
            ...
            jr))
              (s = u[i]) !== (o = r[i]) &&
                ...
                (l = parseFloat(o)),
                (e._pt = new bn(e._pt, r, i, a, l - a, $n)),
                (e._pt.u = c || 0),
                e._props.push(i));
            yr(r, u);
          }
          (sn.version = Vt.version = Fn.version = "3.11.1"),
            (Ee = 1),
            c() && Ft();
          var xr,
            _r,
          ...
          (Fn.utils.checkPrefix = ri),
            (Fn.core.getStyleSaver = Zn),
            (xi = b(
            ...
            Fn.registerPlugin(_i);
          var wi = Fn.registerPlugin(_i) || Fn,
            Ti = wi.core.Tween;
          (e.Back = Br),
            (e.Bounce = Wr),
            (e.CSSPlugin = _i),
      ...
      B = {
        attachEvents: function () {
          ...
          (e.onTouchStart = A.bind(e)),
            ...
            (e.onClick = I.bind(e)),
            r.touch && !$ && (t.addEventListener("touchstart", R), ($ = !0)),
            N(e, "on");
        },
