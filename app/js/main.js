...
const tlAccordion = gsap.timeline({
  scrollTrigger: {
    ...
    onEnter: () => {
      ...
      tlAccordion.fromTo(".services__title", {
        x: "-100%",
        opacity: 0
      }, {
        x: 0,
      ...
      tlParallel.fromTo(accordionItems, {
        y: '-250px'
      }, {
        y: '0',
        duration: 0.7
...
const tlProduction = gsap.timeline({
  scrollTrigger: {
    ...
    //markers: true,
    onEnter: () => {
      tlProduction.fromTo(".block-news__title--top", {
        x: "-100%"
      }, {
        x: 0,
        duration: 0.7
...
const tlSlider = gsap.timeline({
  scrollTrigger: {
    ...
    onEnter: () => {
      ...
      animationGroup.to(".slider__title", {
        x: 0,
        duration: 0.7
      });
...
const tlNews = gsap.timeline({
  scrollTrigger: {
    ...
    //markers: true,
    onEnter: () => {
      tlProduction.fromTo(".block-news__title--bottom", {
        x: "-100%"
      }, {
        x: 0,
        duration: 0.7
      }).fromTo(newsItemsBottom, {
        x: '-100%'
      }, {
        x: 0,
        duration: 0.7
...
const tlWork = gsap.timeline({
  scrollTrigger: {
    ...
    //markers: true,
    onEnter: () => {
      tlProduction.fromTo(".work__title", {
        x: "-100%",
        opacity: 0
      }, {
        x: 0,
